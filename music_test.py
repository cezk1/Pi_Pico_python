...
barka = ["E4", "0", "0", "E4", "0", "0", "D4", "0", "0", "E4", "F4", "E4", "D4", "C4", "0", "0", "C4", "0", "0",
         "D4", "0", "E4", "0", "F4", "F4", "F4", "F4", "F4", "F4"]

drunkensailor = ["D6", "0", "D6", "D6", "D6", "0", "D6", "D6", "D6", "0", "G5", "0", "B5", "0", "D6", "0",
                 "C6", "0", "C6", "C6", "C6", "0", "C6", "C6", "C6", "0", "F5", "0", "A5", "0", "C6", "0",
                 "D6", "0", "D6", "D6", "D6", "0", "D6", "D6", "D6", "0", "E6", "0", "F6", "0", "G6", "0",
                 "F6", "0", "D6", "0", "C6", "0", "A5", "0", "G5", "0", "0", "G5", "0", "0"]

speaker = PWM(Pin(13)) # plus buzzera piezoelektrycznego na pin 13
greenled = Pin(12, Pin.OUT) # wyjscie na diode zielona na pinie 12
yellowled = Pin(11, Pin.OUT) # wyjscie na diode zolta na pinie 11
...
def playnote(Note, Duration):
    if Note == "0":
        sleep(Duration)
    if Note == "S": # S == silence
        speaker.duty_u16(0) # wylaczenie glosnika
        sleep(Duration)
    if Note not in list(MusicNotes.keys()):
        speaker.duty_u16(0)
        sleep(Duration)
    elif Note != "0":
        speaker.duty_u16(0)
        ...
        greenled.toggle()
        yellowled.toggle()
        speaker.duty_u16(10000) # wlaczenie glosnika
        speaker.freq(MusicNotes[Note]) # glosnik gra jakas nute
        sleep(Duration)
